  ...
  return (
    <div className='bg-blue-800 '>
        <div className="max-w-6xl mx-auto py-20 relative ">
            <h3 className='text-center text-4xl font-semi-bold font-poppins text-white'>Apakah anda tertarik dengan kami?</h3>
            <p className='text-center text-gray-200 text-xl semi-bold'>kontak kami untuk konsultasi mengenai web anda</p>
            <a className='bg-white text-blue-500 py-2 px-7  absolute -translate-x-1/2 left-1/2 mt-10 rounded-2xl text-xl font-semibold '>contact</a>
        </div>
        ...
        <p className='text-white text-center '>Develop By Angga bimantoro</p>
    </div>
  )
}
